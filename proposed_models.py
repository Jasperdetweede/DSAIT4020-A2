...
class CustomDataset(Dataset):
	def __init__( self, X, y, embedding=None, device="cpu" ):
		self.device = device
...
def train_joint_model( X_train, X_test, y_train, y_test, e_train, e_test, e_kept_ratio, l=1, epochs=1000, device="cpu" ):
	...
	train_proposal_model( dataset_train_w_e, dataset_train_no_e, dataset_test, model, title="Joint", epochs=epochs, device=device )
...
def train_split_model( X_train, X_test, y_train, y_test, e_train, e_test, e_kept_ratio, epochs=1000, device="cpu" ):
	...
	train_proposal_model( dataset_train_w_e, dataset_train_no_e, dataset_test, model, title="Split", epochs=epochs, device=device )
...
def train_deep_joint_model( X_train, X_test, y_train, y_test, e_train, e_test, e_kept_ratio, l=1, epochs=1000, device="cpu" ):
	...
	train_proposal_model( dataset_train_w_e, dataset_train_no_e, dataset_test, model, title="Deep Joint", epochs=epochs, device=device )
...
def train_deep_split_model( X_train, X_test, y_train, y_test, e_train, e_test, e_kept_ratio, epochs=1000, device="cpu" ):
	...
	train_proposal_model( dataset_train_w_e, dataset_train_no_e, dataset_test, model, title="Deep Split", epochs=epochs, device=device )
...
def gen_datasets( X_train, X_test, y_train, y_test, e_train, e_test, e_kept_ratio, device="cpu" ):
	...
	dataset_train_w_e = CustomDataset( X_train[:n_samples_w_e], y_train[:n_samples_w_e], e_train[:n_samples_w_e], device=device )
	dataset_train_no_e = CustomDataset( X_train[n_samples_w_e:], y_train[n_samples_w_e:], None, device=device )
	dataset_test = CustomDataset( X_test, y_test, e_test, device=device )

	return dataset_train_w_e, dataset_train_no_e, dataset_test

def train_proposal_model( dataset_train_w_e, dataset_train_no_e, dataset_test, model, title, batch_size=32, epochs=1000, device="cpu" ):
	...
	model.fit( dataset_train_no_e, epochs=epochs )
	e_pred_test, y_pred_test = model.predict( dataloader_test )
